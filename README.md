# Tinder API Documentation (and Convenience Scripts)-- 201711

Shoutout to <a href='https://github.com/fbessez'>@fbessez</a> for providing an updated version of the endpoints. I've provided the below verbatim README provided in the previous fork of this awesome repo. Along with some other docs to help with developer workflow.
